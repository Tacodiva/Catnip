...
#define CATNIP_LIST_GET(list, type, index) (*((type*) catinp_list_get((list), sizeof(type), (index))))
inline void* catinp_list_get(catnip_list *list, catnip_ui32_t item_size, catnip_ui32_t index);

#define CATNIP_LIST_REMOVE(list, type, index) (catinp_list_remove((list), sizeof(type), (index)))
inline void catinp_list_remove(catnip_list *list, catnip_ui32_t item_size, catnip_ui32_t index);

#define CATNIP_LIST_LENGTH(list, type) (catinp_list_length((list)))
