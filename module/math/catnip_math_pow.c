...
{
	catnip_f64_t z,ax,z_h,z_l,p_h,p_l;
	catnip_f64_t y1,t1,t2,r,s,t,u,v,w;
	catnip_i32_t i,j,k,yisint,n;
	catnip_i32_t hx,hy,ix,iy;
	catnip_ui32_t lx,ly;
...
// 			{
// 				union {catnip_f64_t f; uint64_t i;} u = {y};
...
// #endif
	...
	if (iy > 0x41e00000) { /* if |y| > 2**31 */
		...
		catnip_f64_t ss,s2,s_h,s_l,t_h,t_l;
		n = 0;
