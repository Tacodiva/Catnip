...
export type convert_ir_inputs = {
    format: CatnipValueFormat,
};

export const ir_convert = new class extends CatnipIrInputOpType<convert_ir_inputs> {

    public constructor() { super("core_convert"); }

    public getOperandCount(): number { return 1; }

    public getResult(ir: CatnipIrInputOp<convert_ir_inputs>): CatnipCompilerValue {

        if (ir.operands[0].isConstant)
            return CatnipCompilerValue.constant(ir.operands[0].constantValue, ir.inputs.format);

        return CatnipCompilerValue.dynamic(this.emitConversion(null, ir.operands[0].format, ir.inputs.format));
    }

    public tryConvert(ir: CatnipIrOp<convert_ir_inputs, {}, this>, format: CatnipValueFormat): boolean {
        ir.inputs.format = format;

        return true;
    }

    public generateWasm(ctx: CatnipCompilerWasmGenContext, ir: CatnipIrInputOp<convert_ir_inputs>): void {
        const srcFormat = ir.operands[0].format;
        const dstFormat = ir.inputs.format;

        this.emitConversion(ctx, srcFormat, dstFormat);
    }

    public stringifyInputs(inputs: convert_ir_inputs): string {
    ...
    public emitConversion(ctx: CatnipCompilerWasmGenContext | null, src: CatnipValueFormat, dst: CatnipValueFormat): CatnipValueFormat {
        ...
        if (CatnipValueFormatUtils.isAlways(src, CatnipValueFormat.F64)) {
            ...
            if (CatnipValueFormatUtils.isAlways(src, CatnipValueFormat.F64_NUMBER_OR_NAN)) {
                ...
                if (CatnipValueFormatUtils.isAlways(dst, CatnipValueFormat.F64_NUMBER)) {
                    ...
                    if (CatnipValueFormatUtils.isSometimes(src, CatnipValueFormat.F64_NAN) && !CatnipValueFormatUtils.isSometimes(dst, CatnipValueFormat.F64_NAN)) {
                        ...
                        return this.emitConversion(ctx, src & (~CatnipValueFormat.F64_NAN), dst);
                    }
                ...
                if (CatnipValueFormatUtils.isAlways(dst, CatnipValueFormat.F64_BOXED_I32_HSTRING)) {
                    return this.emitConversion(ctx, this.emitConversion(ctx, src, CatnipValueFormat.I32_HSTRING), CatnipValueFormat.F64_BOXED_I32_HSTRING);
                }


                if (CatnipValueFormatUtils.isSometimes(dst, CatnipValueFormat.I32_NUMBER)) {
                    if (ctx !== null) {
                        this.emitConversion(ctx, src, CatnipValueFormat.F64_INT);
                ...
                if (CatnipValueFormatUtils.isSometimes(dst, CatnipValueFormat.I32_COLOR)) {
                    this.emitConversion(ctx, src, CatnipValueFormat.I32_NUMBER);
            ...
            if (CatnipValueFormatUtils.isAlways(src, CatnipValueFormat.F64_BOXED_I32_HSTRING)) {
                ...
                return this.emitConversion(ctx, CatnipValueFormat.I32_HSTRING, dst);
            }
            ...
            if (CatnipValueFormatUtils.isSometimes(dst, CatnipValueFormat.I32_COLOR)) {
                ...
                if (ctx !== null) {
                    ...
                    const format = this.emitStringCheck(ctx, src,
                        (ctx) => {
                            ctx.emitWasm(SpiderOpcodes.local_get, value.ref);
                            return this.emitConversion(ctx, CatnipValueFormat.F64_BOXED_I32_HSTRING, CatnipValueFormat.I32_COLOR);
                        },
                        (ctx) => {
                            ctx.emitWasm(SpiderOpcodes.local_get, value.ref);
                            return this.emitConversion(ctx, CatnipValueFormat.F64_NUMBER_OR_NAN, CatnipValueFormat.I32_COLOR);
                        }
                    );
            ...
            if (CatnipValueFormatUtils.isSometimes(dst, CatnipValueFormat.F64_NUMBER_OR_NAN | CatnipValueFormat.I32_NUMBER)) {
                ...
                if (ctx !== null) {
                    ...
                    const format = this.emitStringCheck(ctx, src,
                        (ctx) => {
                            ctx.emitWasm(SpiderOpcodes.local_get, value.ref);
                            return this.emitConversion(ctx, CatnipValueFormat.F64_BOXED_I32_HSTRING, dst);
                        },
                        (ctx) => {
                            ctx.emitWasm(SpiderOpcodes.local_get, value.ref);
                            return this.emitConversion(ctx, CatnipValueFormat.F64_NUMBER_OR_NAN, dst);
                        }
                    );
                    ...
                    return this.emitConversion(ctx, CatnipValueFormat.F64_BOXED_I32_HSTRING, dst) | this.emitConversion(ctx, CatnipValueFormat.F64_NUMBER_OR_NAN, dst);
                }
            }
                ...
                if (ctx !== null) {
                    ...
                    const format = this.emitStringCheck(ctx, src,
                        ...
                        (ctx) => {
                            ...
                            return this.emitConversion(ctx, CatnipValueFormat.F64_NUMBER_OR_NAN, CatnipValueFormat.I32_HSTRING);
                        }
                    );
        ...
        if (CatnipValueFormatUtils.isAlways(src, CatnipValueFormat.I32)) {
            ...
            if (CatnipValueFormatUtils.isAlways(src, CatnipValueFormat.I32_BOOLEAN)) {
                ...
                if (CatnipValueFormatUtils.isSometimes(dst, CatnipValueFormat.F64_NUMBER)) {
                    ...
                    return this.emitConversion(ctx, CatnipValueFormat.F64_ZERO | CatnipValueFormat.F64_POS_INT, dst);
                }
            }
            ...
            if (CatnipValueFormatUtils.isAlways(src, CatnipValueFormat.I32_NUMBER)) {
                ...
                return this.emitConversion(ctx, CatnipValueFormat.F64_INT, dst);
            }
